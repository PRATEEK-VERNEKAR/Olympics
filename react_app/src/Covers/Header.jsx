        ...
        <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center justify-end">
          ...
          <nav className="flex lg:w-3/5 flex-wrap items-center justify-end text-xl md:ml-auto ">
            ...
            </NavLink>
            {
              type===undefined?(
                <>
                <NavLink to="/login" className="flex items-center mr-5 hover:text-gray-900">
                  <img src={login} alt="" className="h-5 w-5 mr-1 hover:scale-110"/>
                Login
                </NavLink>
                </>
              ):(
                ...
                (
                  <>
                    ...
                    <button onClick={dologout} className="flex items-center mr-5 hover:text-gray-900">
                      Logout
                    </button>
                  </>
                ):
            ...
            <NavLink to="/signertype" className="flex items-center mr-5 hover:text-gray-900">
              <img src={signup} alt="" className="h-5 w-5 mr-1 hover:scale-110"/>Sign Up
            </NavLink>
