...
const Post = () => {
  ...
  const [backgroundImage, setBackgroundImage] = useState(upload);
  ...
  const handleFileChange = (e) => {
    ...
    // Read the selected file and set it as the background image
  ...
  //     const desiredWidth = 200; // Set your desired width here
  ...
  //       const resizedImage = canvas.toDataURL(); // The resized image as a data URL

  //       // Store the resized image or perform further processing here
  ...
  return (
    ...
    <form className="flex" style={{height:"36rem"}}>
      {
        youorwho?(

          <div className="w-1/2 text-center border-2 border-red-500">        
            <div className="h-min border-b border-gray-200 dark:border-gray-700 bg-green-100">
                <ul className="h-full flex justify-evenly flex-wrap -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400">
                    <li className="mr-2 my-auto">
                        <button onClick={(e)=>{e.preventDefault()
                                              settab1(false)
                                              seePhotos()
                                              }}
                            className={(tab1?"inline-flex items-center justify-center p-4 m-2 text-blue-600 rounded-t-lg  dark:text-blue-500 dark:border-blue-500 group":"active inline-flex items-center justify-center p-4 text-md text-blue-600 border-b-2 border-t-2 border-blue-600 rounded-t-lg dark:text-blue-500 dark:border-blue-500 group")}
                            >
                    ...
                    <li className="mr-2 my-auto">
                        <button onClick={(e)=>{e.preventDefault()
                                              settab1(true)}} 
                            className={(tab1?"active inline-flex items-center justify-center p-4 text-md text-blue-600 border-b-2 border-t-2 border-blue-600 rounded-t-lg dark:text-blue-500 dark:border-blue-500 group":"inline-flex items-center justify-center p-4 m-2 text-blue-600 rounded-t-lg dark:text-blue-500 dark:border-blue-500 group")} aria-current="page"
                            >
              ...
              tab1?(
                <div className="h-3/4 flex flex-col justify-end">
                  <input 
                    ...
                    className=' mx-auto my-auto m-4 text-center bg-cover bg-no-repeat border-2 border-stone-400 rounded-xl hover:cursor-pointer' 
                    style={{ height:'90%' , width:'90%', backgroundImage:`url(${backgroundImage})`, backgroundPosition:`center`, backgroundSize:'80% 80%'}}>
                  </input>
                </div>
              ):
              <div className="h-3/4 overflow-y-scroll">
                  {
                    disimg.map((ele)=>{
                      return(
                        <div key={ele._id} className="flex flex-col justify-evenly border-4 border-red-200 bg-fuchsia-100" style={{height:'85%'}}>
                          <img src={ele.img}  className=" mx-auto border-4 border-indigo-950"
                          style={{height:'80%', width:'65%', boxShadow:'8px 8px 10px red'}}></img>
                          <img src={like} className='mx-auto shadow-lg mt-3 hover:scale-150' style={{height:'30px' ,width:'30px'}}></img>
                        </div>
                      )
                    })
                  }
